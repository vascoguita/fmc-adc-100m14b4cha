...
int main(int argc, char *argv[])
{
	...
	fmcadc_set_attr_mask(&trg, FMCADC_CONF_TRG_SOURCE);
	fmcadc_set_attr_mask(&trg, FMCADC_CONF_TRG_SOURCE_CHAN);
	fmcadc_set_attr_mask(&trg, FMCADC_CONF_TRG_THRESHOLD);
	fmcadc_set_attr_mask(&trg, FMCADC_CONF_TRG_POLARITY);
	...
	fmcadc_set_attr_mask(&acq, FMCADC_CONF_ACQ_N_SHOTS);
	fmcadc_set_attr_mask(&acq, FMCADC_CONF_ACQ_POST_SAMP);
	fmcadc_set_attr_mask(&acq, FMCADC_CONF_ACQ_PRE_SAMP);
	fmcadc_set_attr_mask(&acq, FMCADC_CONF_ACQ_DECIMATION);
	fmcadc_set_attr_mask(&acq, FMCADC_CONF_ACQ_FREQ_HZ);
	...
	for (i = 0; i < brd.value[FMCADC_BOARD_N_CHAN]; ++i) {
		...
		chn.route_to = i;
		fmcadc_set_attr_mask(&chn, FMCADC_CONF_CHN_RANGE);
		fmcadc_set_attr_mask(&chn, FMCADC_CONF_CHN_TERMINATION);
